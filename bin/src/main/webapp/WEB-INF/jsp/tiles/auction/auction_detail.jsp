...
<div class="container">
	<div id="auctionForm">
		...
		<br />
		<br> <br> <b>현재 최고가 : <fmt:formatNumber
				value="${auction.maxPrice}" pattern="#,###원" /></b>
		<p>
			...
			<form:form modelAttribute="bidForm" method="post"
				...
				<c:if test="${auction.state eq 'proceeding'}">
					<form:input type="number" path="bid.bidPrice" class="form-control" /> &nbsp;&nbsp;
                        <input id="register-btn" type="button"
						value="신청하기" onClick="bid()">
				</c:if>
...
<div class="form-group">
	...
	<a id="auction-register-btn"
		href="<c:url value='/auction/list'></c:url>">목록</a>
</div>